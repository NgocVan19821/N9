...
class SpotifyListAdapter(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.title_label.text = item.title
        if (position == SpotifyRecyclerviewActivity.SIX_PACK)
            ...
            holder.itemView.list_item_artist.layoutManager = LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false)
        }
        holder.itemView.list_item_artist.adapter = ArtistAdapter(position, item.listArtist) //
    }
